...
public class ViewContollerStub implements IViewController {
	...
	@Override
	public int calculateCurrentPage(final ViewState viewState, final int firstVisible,
	...
	@Override
	public boolean onLayoutChanged(final boolean layoutChanged, final boolean layoutLocked,
			final Rect oldLaout, final Rect newLayout) {
		return false;
	}
