...
public abstract class MuPdfContext extends AbstractCodecContext {
	...
	public static final int MUPDF_FEATURES = FEATURE_CACHABLE_PAGE_INFO | FEATURE_EMBEDDED_OUTLINE | FEATURE_PAGE_TEXT_SEARCH | FEATURE_POSITIVE_IMAGES_IN_NIGHT_MODE
	...
	public void setExternalFonts() {
		...
		setMonoFonts(monoFonts[FontStyle.REGULAR.ordinal()], monoFonts[FontStyle.ITALIC.ordinal()], monoFonts[FontStyle.BOLD.ordinal()], monoFonts[FontStyle.BOLD_ITALIC.ordinal()]);

		final String[] sansFonts = FontManager.getExternalFonts(app.sansFontPack, FontFamilyType.SANS);

		setSansFonts(sansFonts[FontStyle.REGULAR.ordinal()], sansFonts[FontStyle.ITALIC.ordinal()], sansFonts[FontStyle.BOLD.ordinal()], sansFonts[FontStyle.BOLD_ITALIC.ordinal()]);

		final String[] serifFonts = FontManager.getExternalFonts(app.serifFontPack, FontFamilyType.SERIF);

		setSerifFonts(serifFonts[FontStyle.REGULAR.ordinal()], serifFonts[FontStyle.ITALIC.ordinal()], serifFonts[FontStyle.BOLD.ordinal()],
				serifFonts[FontStyle.BOLD_ITALIC.ordinal()]);

		final String symbolFont = FontManager.getExternalFont(app.symbolFontPack, FontFamilyType.SYMBOL, FontStyle.REGULAR);
		setSymbolFont(symbolFont);

		final String dingbatFont = FontManager.getExternalFont(app.dingbatFontPack, FontFamilyType.DINGBAT, FontStyle.REGULAR);
