...
public class GLBitmaps {
	...
	protected boolean draw(final GLCanvas canvas, final int row, final int col, final ByteBufferTexture t, final RectF actual, final RectF src, final RectF rect, final RectF r) {
		boolean tres = false;
		if (t != null) {
			r.set(rect);
