...
public class BookSettings implements CurrentPageListener {
	...
	BookSettings(final JSONObject object) throws JSONException {
		...
		this.gamma = object.optInt("gamma", 100);
	...
	public static class Diff {
		...
		private static final short D_Effects = D_Contrast | D_Exposure | D_NightMode | D_PositiveImagesInNightMode | D_AutoLevels | D_Gamma;
