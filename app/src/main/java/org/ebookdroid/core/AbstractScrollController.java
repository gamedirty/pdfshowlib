...
public abstract class AbstractScrollController extends AbstractViewController {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.ebookdroid.core.AbstractViewController#onLayoutChanged(boolean,
	 *      boolean, android.graphics.Rect, android.graphics.Rect)
	 */
	@Override
	public final boolean onLayoutChanged(final boolean layoutChanged, final boolean layoutLocked,
	...
	public final void onScrollChanged(final int dX, final int dY) {
		...
		EventPool.newEventScroll(this, mode == DocumentViewMode.VERTICALL_SCROLL ? dY : dX)
				.process().release();
	}
