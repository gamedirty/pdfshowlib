...
public class DecodeServiceBase implements DecodeService {
	...
	void finishDecoding(final DecodeTask currentDecodeTask, final CodecPage page, final ByteBufferBitmap bitmap, final Rect bitmapBounds, final RectF croppedPageBounds) {
	...
	void updateImage(final DecodeTask currentDecodeTask, final CodecPage page, final ByteBufferBitmap bitmap, final Rect bitmapBounds, final RectF croppedPageBounds) {
	...
	@Override
	public IBitmapRef createThumbnail(final boolean useEmbeddedIfAvailable, int width, int height, final int pageNo, final RectF region) {
		if (document == null) {
			return null;
		}
